...
- Дата регистрации выбирается от дня, когда открылся реестр, до конца 2026 года: с 01.07.2002
  у организации, с 01.01.2004 у предпринимателя. Верхняя граница зафиксирована константой —
  привязка к текущей дате сломала бы воспроизводимость по seed, — поэтому дата бывает и позже
  сегодняшнего дня.
